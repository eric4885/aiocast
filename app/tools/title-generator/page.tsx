...
const canonical = `${siteConfig.url}/tools/title-generator`;

export const metadata: Metadata = {
  title: "Free podcast episode title generator — SEO title ideas",
  description:
    ...
    <div className="bg-background">
      <div className="mx-auto max-w-4xl px-4 pb-4 pt-8 text-center sm:px-6 sm:pt-10">
        <h1 className="text-balance text-3xl font-bold tracking-tight sm:text-4xl">
          Free podcast episode title ideas
        </h1>
        <p className="mx-auto mt-4 max-w-2xl text-[15px] leading-relaxed text-muted-foreground">
          Sharpen your headline before you record. For the SEO article, FAQ blocks, and social scripts, use{" "}
