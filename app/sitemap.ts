...
const entries: SitemapEntry[] = [
  ...
  { path: "/guides/show-notes-template", priority: 0.95, changeFrequency: "weekly", lastModified: "2026-08-29" },
  ...
  { path: "/tools/free-podcast-title-generator", priority: 0.85, changeFrequency: "monthly", lastModified: "2026-08-29" },
