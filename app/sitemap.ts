...
const entries: SitemapEntry[] = [
  ...
  { path: "/resources", priority: 0.75, changeFrequency: "monthly", lastModified: "2026-09-17" },
  { path: "/resources/pre-flight-checklist", priority: 0.75, changeFrequency: "monthly", lastModified: "2026-09-10" },
  { path: "/pro-toolkit", priority: 0.7, changeFrequency: "monthly", lastModified: "2026-09-17" },
