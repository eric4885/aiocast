    ...
    <div className="mx-auto max-w-3xl px-4 py-16 text-foreground">
      ...
      <div className="mt-8 space-y-5 text-sm leading-relaxed text-muted-foreground">
        ...
        <p>
          ...
          scripts, and related assets. Features and limits may change; we may add or remove functionality with reasonable
        ...
        <p>
          You retain rights to content you submit (for example transcripts and topics). To operate the Service, you grant
          us a limited license to host, process, transmit, and display that content solely to provide and improve the
          Service — including sending portions to AI subprocessors when that feature is enabled.
        </p>
        <p>
        ...
        <h2 className="text-lg font-semibold text-foreground">4. AI-assisted outputs</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-foreground">5. Intellectual property (site)</h2>
        <p>
        ...
        <h2 className="text-lg font-semibold text-foreground">8. Free tiers, fair use, and paid offerings</h2>
        <p>
          We may apply rate limits (for example per email or IP). You agree not to circumvent limits or abuse the
          Service. When paid checkout is offered, price, billing, and refund terms will be presented at purchase and may
          supplement these Terms. Until checkout is live, references to “Pro” or upgrades are forward-looking and may link
          to waitlists or contact flows.
        </p>
        ...
        <h2 className="text-lg font-semibold text-foreground">11. Governing law and disputes</h2>
        <p>
